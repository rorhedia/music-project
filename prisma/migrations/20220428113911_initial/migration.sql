...
-- AddForeignKey
ALTER TABLE `PaylistWithSongs` ADD CONSTRAINT `PaylistWithSongs_songId_fkey` FOREIGN KEY (`songId`) REFERENCES `Song`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PaylistWithSongs` ADD CONSTRAINT `PaylistWithSongs_playlistId_fkey` FOREIGN KEY (`playlistId`) REFERENCES `Playlist`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
